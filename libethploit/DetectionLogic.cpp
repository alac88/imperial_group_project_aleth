...
in file /Users/zijian/Code/group_project/imperial_group_project_aleth/build/souffle/bin/DetectionLogic.dl [30:1-30:98])_");
...
SignalHandler::instance()->setMsg(R"_(reentrancy(C2,A1,A2,P,P2) :- 
   ...
   call(_,A2,A1,P2),
   A1 != A2.
in file /Users/zijian/Code/group_project/imperial_group_project_aleth/build/souffle/bin/DetectionLogic.dl [32:1-32:86])_");
if(!(rel_3_call->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_3_call_op_ctxt,rel_3_call->createContext());
...
SignalHandler::instance()->setMsg(R"_(locked_ether(A1,G2) :- 
   call_entry(G2,A1),
   call_exit(G2).
in file /Users/zijian/Code/group_project/imperial_group_project_aleth/build/souffle/bin/DetectionLogic.dl [60:1-60:66])_");
