...
wrapper_rel_8_call_result(*rel_8_call_result,symTable,"call_result",std::array<const char *,2>{{"s:result[s:symbol]","i:NatNum[i:number]"}},std::array<const char *,2>{{"a","v"}}),

wrapper_rel_9_depends(*rel_9_depends,symTable,"depends",std::array<const char *,2>{{"s:result[s:symbol]","s:opcodeArg[s:symbol]"}},std::array<const char *,2>{{"a","b"}}),
...
wrapper_rel_11_in_condition(*rel_11_in_condition,symTable,"in_condition",std::array<const char *,1>{{"s:result[s:symbol]"}},std::array<const char *,1>{{"a"}}),

wrapper_rel_12_influences_condition(*rel_12_influences_condition,symTable,"influences_condition",std::array<const char *,1>{{"s:result[s:symbol]"}},std::array<const char *,1>{{"a"}}),

wrapper_rel_13_is_output(*rel_13_is_output,symTable,"is_output",std::array<const char *,2>{{"s:result[s:symbol]","s:opcodeArg[s:symbol]"}},std::array<const char *,2>{{"a","b"}}),
...
wrapper_rel_16_unhandled_exception(*rel_16_unhandled_exception,symTable,"unhandled_exception",std::array<const char *,1>{{"s:opcodeArg[s:symbol]"}},std::array<const char *,1>{{"a"}}){
...
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Symbol,RamTypeAttribute::Symbol,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->readAll(*rel_10_direct_call);
...
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Symbol,RamTypeAttribute::Symbol,RamTypeAttribute::Signed,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->writeAll(*rel_15_reentrancy);
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Signed,RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->readAll(*rel_6_call_entry);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
if (performIO) {
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->readAll(*rel_7_call_exit);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
...
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Signed,RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->writeAll(*rel_14_locked_ether);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->readAll(*rel_8_call_result);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
if (performIO) {
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol,RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->readAll(*rel_13_is_output);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
SignalHandler::instance()->setMsg(R"_(depends(A,B) :- 
   is_output(A,B).
in file /vol/project/2019/530/g1953010/souffle/MarkT/DetectionLogic.dl [109:1-109:34])_");
...
SignalHandler::instance()->setMsg(R"_(depends(A,B) :- 
   is_output(A,C),
   depends(C,B).
in file /vol/project/2019/530/g1953010/souffle/MarkT/DetectionLogic.dl [110:1-110:49])_");
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->readAll(*rel_11_in_condition);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
SignalHandler::instance()->setMsg(R"_(influences_condition(A) :- 
   in_condition(A).
in file /vol/project/2019/530/g1953010/souffle/MarkT/DetectionLogic.dl [114:1-114:44])_");
...
SignalHandler::instance()->setMsg(R"_(influences_condition(A) :- 
   depends(B,A),
   in_condition(B).
in file /vol/project/2019/530/g1953010/souffle/MarkT/DetectionLogic.dl [115:1-115:59])_");
...
in file /vol/project/2019/530/g1953010/souffle/MarkT/DetectionLogic.dl [119:1-119:71])_");
...
const Tuple<RamDomain,2> key{{0,RamSigned(0)}};
...
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->writeAll(*rel_16_unhandled_exception);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
...
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Symbol,RamTypeAttribute::Symbol,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->writeAll(*rel_10_direct_call);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("call_entry");
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Signed,RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->writeAll(*rel_6_call_entry);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("call_exit");
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Signed,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->writeAll(*rel_7_call_exit);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("call_result");
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol,RamTypeAttribute::Signed}), symTable, ioDirectives, 0)->writeAll(*rel_8_call_result);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("is_output");
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol,RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->writeAll(*rel_13_is_output);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("in_condition");
IOSystem::getInstance().getWriter(std::vector<RamTypeAttribute>({RamTypeAttribute::Symbol}), symTable, ioDirectives, 0)->writeAll(*rel_11_in_condition);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
