...
//  double blockFees = 15.0;
    ...
    addClientOption("ethploit", "Ethploit mode; enable detection of potential exploitation (default: off); The detection results can be found in 'reentrancy.json', 'locked_ether.json' and 'unhandled_exception.json' under aleth build directory");
